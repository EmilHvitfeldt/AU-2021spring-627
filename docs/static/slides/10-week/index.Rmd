...
We saw last week how PCA can be used as a dimensionality reduction method
...
We cannot predict directly on a fitted Ridge model because we need to specify the penalty
